...
SceneManager._screenWidth  = Number(Yanfly.Parameters['Screen Width'] || 1920);
SceneManager._screenHeight = Number(Yanfly.Parameters['Screen Height'] || 1080);
SceneManager._boxWidth     = Number(Yanfly.Parameters['Screen Width'] || 1920);
SceneManager._boxHeight    = Number(Yanfly.Parameters['Screen Height'] || 1080);
